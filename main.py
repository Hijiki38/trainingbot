...
def tweet_bot():
    ...
    chest_list = ["ひざつきプッシュアップ","プッシュアップ","インクラインプッシュアップ","ヒンズープッシュアップ"]
    core_list = ["ロシアンツイスト","サイドベント","グッドモーニング","プランク","ニートゥチェスト","マウンテンクライマー" \
        ,"ｽﾜｲｼｮｳ","ヒールタッチ","クロスオーバークランチ","サイドブリッジ","Vアップ","サイドプランク","シットアップ"]
    leg_list = ["ワイドスクワット","ヒップリフト","レッグアダクション","ドンキーキック","ファイヤーハイドラント"]
